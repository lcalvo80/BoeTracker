...
ADV_FIELDS = {
  ...
  # seccion / departamento se tratan de forma especial (código o nombre)
}
  ...
  for tok in tokens:
    ...
    if ":" in t:
      ...
      if field in ("seccion", "departamento"):
        ...
        (negative if is_neg else positive).append(("NOT " if is_neg else "") + clause if is_neg else clause)
        ...
        # campo desconocido -> buscar como texto libre
